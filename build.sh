	...
	then
		...
		if [ "$kernel_ver" == "1" ]
			...
			then
				...
				KERNEL_REV="r17"
				KERNEL_NAME="Clarity"
				KERNEL_BRANCH="dev/kasumi-rework"
				...
				# Upstream current revision
				git checkout dev/kasumi-rework
				git fetch https://github.com/Nicklas373/kernel_xiaomi_msm8953-3.18-2 dev/kasumi-rework && git merge FETCH_HEAD
				if [ "$kernel_ver" == 2 ]
					then
						cd ${HOME}/hana/AnyKernel3
						git checkout mido-10
				...
				# Import git start commit
				COMMIT="952a0dc6bee842bef0f4b4a5a63b43a0d0998180"
