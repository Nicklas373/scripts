...
bot_env() {
TELEGRAM_KERNEL_VER=$(cat ~/kernel_xiaomi_lavender/out/.config | grep Linux/arm64 | cut -d " " -f3)
TELEGRAM_UTS_VER=$(cat ~/kernel_xiaomi_lavender/out/include/generated/compile.h | grep UTS_VERSION | cut -d '"' -f2)
TELEGRAM_COMPILER_NAME=$(cat ~/kernel_xiaomi_lavender/out/include/generated/compile.h | grep LINUX_COMPILE_BY | cut -d '"' -f2)
TELEGRAM_COMPILER_HOST=$(cat ~/kernel_xiaomi_lavender/out/include/generated/compile.h | grep LINUX_COMPILE_HOST | cut -d '"' -f2)
TELEGRAM_TOOLCHAIN_VER=$(cat ~/kernel_xiaomi_lavender/out/include/generated/compile.h | grep LINUX_COMPILER | cut -d '"' -f2)
}
...
bot_template  "<b>||*HANA-CI Build Bot*||</b>" \
              ...
              "" \
              "<b>Device :</b><code> Xiaomi Redmi Note 7</code>" \
              "" \
